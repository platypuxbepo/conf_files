...
alias cdprpy="cd ~/programmes/programming/python"
alias cdprjv="cd ~/programmes/programming/java"
alias cdpr="cd ~/programmes/programming"
alias cdprcpp="cd ~/programmes/programming/cpp"
