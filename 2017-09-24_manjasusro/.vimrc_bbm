...
" show indent lines with this nice char w/ indentline plugin (for spaces only)
let g:indentLine_char = '┆'

" show indent lines with this nice char w/o indentline plugin (for tabs only)
set list lcs=tab:\┆\  
